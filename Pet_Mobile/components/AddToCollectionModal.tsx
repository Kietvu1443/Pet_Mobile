...
export function AddToCollectionModal({
  ...
  const toggleMutation = useMutation({
    ...
    onMutate: async ({ collectionId, isMember }) => {
      ...
      const previousIds =
        queryClient.getQueryData<number[]>(["pet-collections", petId]) || [];
              ...
              {collections.map((col: RawCollection) => {
                ...
                return (
                  ...
                  >
                    ...
                    <Text
                      style={[styles.petCount, { color: theme.colors.muted }]}
                    >
                      {col.pet_count ?? 0} bé
                    </Text>
            ...
            >
              ...
              <View style={styles.formActions}>
                ...
                <Pressable
                  ...
                  disabled={
                    createMutation.isPending || !newCollectionName.trim()
                  }
                >
