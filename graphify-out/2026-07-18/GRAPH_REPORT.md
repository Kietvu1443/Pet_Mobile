# Graph Report - Pet_Helper_Mobile  (2026-07-03)

## Corpus Check
- 163 files · ~3,354,989 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1270 nodes · 1625 edges · 121 communities (104 shown, 17 thin omitted)
...
Cohesion: 0.12
Nodes (11): notificationService, { pool }, notificationService, petReturnRepository, petReturnService, petReturnValidation, { pool }, petReturnValidation (+3 more)
...
Cohesion: 0.11
Nodes (15): EmailVerification, {
  generateRegistrationOptions,
  verifyRegistrationResponse,
  generateAuthenticationOptions,
  verifyAuthenticationResponse,
}, jwt, { JWT_SECRET }, { Resend }, { sendSuccess, sendError }, User, UserConnection (+7 more)
...
Cohesion: 0.11
Nodes (23): getTokenFromRequest(), getUserFromToken(), jwt, { JWT_SECRET }, requireApiAuth(), requireApiRole(), requireApiVerified(), { sendError } (+15 more)
...
Cohesion: 0.10
Nodes (14): mysql, pool, { pool }, EmailVerification, { pool }, PetLike, { pool }, { pool } (+6 more)
...
Cohesion: 0.11
Nodes (10): RegisterData, ApiError, RootNavigator(), unstable_settings, AuthProvider(), useAuth(), LoginScreen(), styles (+2 more)
...
Cohesion: 0.14
Nodes (20): AuthConfig, getAuthConfig(), getMe(), login(), LoginResponse, MeResponse, register(), User (+12 more)
...
Cohesion: 0.24
Nodes (12): fetchNextPet(), postDislike(), postLike(), RawPet, RawPetImage, RawPetSnapBundle, resolveImageUrl(), adaptPet() (+4 more)
...
Cohesion: 0.48
Nodes (5): API_ORIGIN, devBaseUrl(), metroHost(), platformLocalhost(), resolveBaseUrl()
...
## Knowledge Gaps
- **758 isolated node(s):** `__routes`, `name`, `slug`, `version`, `orientation` (+753 more)
...
- **Why does `pool` connect `Migrations & PetLike` to `Auth Controller & JWT`, `Cloudinary Migration Script`, `Pet Return Tests`, `Admin API Controller`, `Pet Return Validation`, `News Service`, `Pet Return Service Layer`, `PetImage & Report Service`, `Favorites Controller`, `Adoption Request Service`, `Community 118`, `Community 95`?**
