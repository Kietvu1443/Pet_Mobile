# Graph Report - Pet_Helper_Mobile  (2026-06-17)

## Corpus Check
- 159 files · ~3,350,349 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1252 nodes · 1598 edges · 118 communities (106 shown, 12 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 53 edges (avg confidence: 0.83)
...
- `TabLayout()` --calls--> `useColorScheme()`  [INFERRED]
  Pet_Mobile/app/(tabs)/_layout.tsx → Pet_Mobile/hooks/use-color-scheme.web.ts
- `RootNavigator()` --calls--> `useColorScheme()`  [INFERRED]
  Pet_Mobile/app/_layout.tsx → Pet_Mobile/hooks/use-color-scheme.web.ts
...
Cohesion: 0.08
Nodes (22): ALLOWED_STATUSES, { mapUploadedFiles }, notificationService, petReturnController, petReturnService, { sendSuccess, sendError }, { cloudinary, isProduction, getCloudinaryId }, { CloudinaryStorage } (+14 more)
...
Cohesion: 0.12
Nodes (12): adminApiV1Controller, ALLOWED_REPORT_ACTIONS, ALLOWED_ROLES, ALLOWED_STATUSES, { pool }, Report, { sendSuccess, sendError }, User (+4 more)
...
Cohesion: 0.10
Nodes (16): authRateLimiter, path, swaggerSpec, swaggerUi, YAML, express, path, router (+8 more)
...
Cohesion: 0.12
Nodes (13): EmailVerification, {
  generateRegistrationOptions,
  verifyRegistrationResponse,
  generateAuthenticationOptions,
  verifyAuthenticationResponse,
}, jwt, { JWT_SECRET }, { Resend }, { sendSuccess, sendError }, User, UserConnection (+5 more)
...
Cohesion: 0.15
Nodes (17): getTokenFromRequest(), getUserFromToken(), jwt, { JWT_SECRET }, requireApiAuth(), requireApiRole(), requireApiVerified(), { sendError } (+9 more)

### Community 21 - "Legacy Page Routers"
Cohesion: 0.04
Nodes (46): dependencies, expo, expo-constants, expo-font, @expo-google-fonts/fredoka, expo-haptics, expo-image, expo-linear-gradient (+38 more)
...
Cohesion: 0.12
Nodes (11): mysql, pool, { pool }, STATEMENTS, { pool }, PetLike, { pool }, { pool } (+3 more)

### Community 24 - "Adoption Request Controller"
Cohesion: 0.16
Nodes (11): adoptionRequestApiV1Controller, adoptionRequestService, allowedStatuses, { sendSuccess, sendError }, favoritesApiV1Controller, Pet, PetLike, { sendSuccess, sendError } (+3 more)

### Community 25 - "PetSnap Swipe Controller"
Cohesion: 0.15
Nodes (11): getNextPetBundle(), normalizePet(), Pet, PetImage, PetLike, petSnapApiV1Controller, { sendSuccess, sendError }, express (+3 more)
...
Cohesion: 0.12
Nodes (20): HapticTab(), ParallaxScrollView(), Props, styles, styles, ThemedText(), ThemedTextProps, ThemedView() (+12 more)
...
Cohesion: 0.07
Nodes (28): backgroundColor, backgroundImage, foregroundImage, monochromeImage, adaptiveIcon, edgeToEdgeEnabled, predictiveBackGestureEnabled, reactCompiler (+20 more)
...
Cohesion: 0.12
Nodes (16): SNAP_COLORS, SNAP_FONTS, Pet, PetCard(), styles, SnapBackground(), styles, FAB_ART (+8 more)
...
### Community 55 - "User Model"
Cohesion: 0.15
Nodes (15): ApiEnvelope, ApiError, RequestOptions, setUnauthorizedHandler(), RootNavigator(), unstable_settings, AuthContext, AuthContextValue (+7 more)

### Community 56 - "UserConnection Model"
Cohesion: 0.09
Nodes (21): APPENDICES - Real Source-Backed Reference Material, Appendix A - Install Commands per Design System, Appendix B - Canonical Sources (read these before reinventing), Appendix C - Apple Liquid Glass: Honest Web Approximation, Apple Liquid Glass (Apple platforms only), Atlassian, Bootstrap, Carbon (+13 more)

### Community 57 - "UserPasskey Model"
Cohesion: 0.10
...
Cohesion: 0.16
Nodes (15): AuthConfig, getAuthConfig(), getMe(), login(), LoginResponse, MeResponse, User, apiRequest() (+7 more)
...
Cohesion: 0.15
Nodes (12): 1. Sử dụng Docker (Khuyên dùng), 2. Cài đặt thủ công (Local), 🛠️ Công nghệ sử dụng, 📁 Cấu trúc thư mục, 👑 Dành cho Admin (Quản trị viên), 👤 Dành cho Người dùng, 🛠️ Dành cho Staff (Nhân viên), 🚀 Hướng dẫn cài đặt (+4 more)

### Community 69 - "Community 69"
Cohesion: 0.15
Nodes (12): 1. Phân hệ Quản lý Tài khoản, 2. Phân hệ Tương tác Thú cưng, 3. Phân hệ Nhận nuôi, 4. Phân hệ Báo cáo Thất lạc, 5. Phân hệ Dịch vụ & Tiện ích, Danh sách các tệp sơ đồ liên quan:, UC_User_Account_01: Đăng ký tài khoản, UC_User_Adopt_01: Gửi yêu cầu nhận nuôi (+4 more)
...
Cohesion: 0.18
Nodes (10): 1. Phân hệ Quản lý Người dùng (Đặc quyền Admin), 2. Phân hệ Quản lý Báo cáo nâng cao, 3. Phân hệ Vận hành (Chia sẻ với Staff), Danh sách các tệp sơ đồ liên quan:, UC_Admin_Adopt_01: Xét duyệt nhận nuôi, UC_Admin_Pet_01: Quản lý thú cưng, UC_Admin_Report_01: Xử lý vi phạm từ báo cáo, UC_Admin_User_01: Thay đổi quyền hạn (Update Role) (+2 more)

### Community 72 - "Community 72"
Cohesion: 0.31
Nodes (8): API_ORIGIN, defaultDevBaseUrl(), resolveBaseUrl(), resolveImageUrl(), adaptPet(), buildPhotos(), emptyToNull(), PetPhoto

### Community 73 - "Community 73"
Cohesion: 0.18
Nodes (10): 1. Phân hệ Quản lý Thú cưng, 2. Phân hệ Quy trình Nhận nuôi, 3. Phân hệ Xử lý Báo cáo, 4. Các quyền hạn khác, Danh sách các tệp sơ đồ liên quan:, UC_Staff_Adopt_01: Xét duyệt hồ sơ nhận nuôi, UC_Staff_Pet_01: Thêm thú cưng mới, UC_Staff_Pet_02: Cập nhật/Xóa thú cưng (+2 more)
...
Cohesion: 0.22
Nodes (7): Backend architecture, Backend (`Pet_helper/backend`), Commands, graphify, Mobile architecture, Mobile (`Pet_Mobile`), Workspace layout
...
Cohesion: 0.50
Nodes (3): fetchMyFavorites(), MyFavoritesResponse, RawFavorite
...
## Knowledge Gaps
- **755 isolated node(s):** `__routes`, `name`, `slug`, `version`, `orientation` (+750 more)
...
- **Why does `pool` connect `Migrations & PetLike` to `Auth Controller & JWT`, `Pet Return Service Layer`, `Cloudinary Migration Script`, `Admin API Controller`, `Pet Return Tests`, `News Service`, `PetImage & Report Service`, `Favorites Controller`, `Passkey/WebAuthn Auth`, `Adoption Request Service`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **Why does `tasteskill: Anti-Slop Frontend Skill` connect `Community 75` to `Community 96`, `Community 70`, `Community 74`, `Community 79`, `Community 82`, `Community 83`, `Community 84`, `UserConnection Model`, `Community 91`, `Community 92`, `Community 93`, `Community 94`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **Why does `sendError()` connect `Adoption Request Controller` to `News Route`, `Pets Route`, `Reports Route`, `Pet Return Controller`, `OAuth Login (Google/FB)`, `Admin API Controller`, `News & Report Services`, `Passkey/WebAuthn Auth`, `Pet API Controller`, `Report API Controller`, `Auth Profile Controller`, `API Auth Guards (v1)`, `PetSnap Swipe Controller`?**
